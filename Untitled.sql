...
CREATE TABLE `bitstampmarktdata` (
  ...
  `High` double NOT NULL DEFAULT '-1',
  `Low` double NOT NULL DEFAULT '-1',
  `Bid` double NOT NULL DEFAULT '-1',
  `Ask` double NOT NULL DEFAULT '-1',
  `Datum` varchar(45) DEFAULT NULL,
  `Time` varchar(45) DEFAULT NULL,
  `VolumeBTC` double NOT NULL DEFAULT '-1',
  `Last` double NOT NULL DEFAULT '-1',
  PRIMARY KEY (`id`)
...
-- Dump completed on 2017-03-28 13:16:00
